...
const BottomSection = () => {
  return (
    <div className='bottom__section'>
      ...
      <div className=' w-full h-[238px] sm:h-[243px] sm:w-[29.2%]'>
         <Image src={'/image-about-dark.jpg'} alt='desktopImage'
            height={500} width={500} className='w-full h-full'          
              />
      </div>
      
      <div className=' w-full h-[301px] sm:w-2/5 sm:h-[243px] flex items-center justify-center '>
        <div className='w-[310px] h-[204px] sm:h-[200px] md:h-[180px] lg:h-[150px] lg:w-[438px]'>
      ...
      <div className=' w-full h-[228px] sm:h-[243px] sm:w-[30.8%]'>
